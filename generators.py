...
class NLBlockND_cross(nn.Module):
    ...
    def __init__(self, in_channels, inter_channels=None, mode='embedded',
        ...
        args:
            ...
            inter_channels: channel size inside the block if not specifed reducedconda install -c https://conda.anaconda.org/simpleitk SimpleITKation
    ...
    def __init__(self):
        ...
        for m in self.modules():
            ...
            if isinstance(m, nn.Conv3d):
                #kaiming_norm
                m.weight = nn.init.kaiming_normal(m.weight, mode='fan_in') #fan_out is the original option
            elif isinstance(m, nn.BatchNorm3d):
                m.weight.data.fill_(1)
                m.bias.data.zero_()

    def forward(self, x, case_id = None):
        #print("x", x.shape)
        ...
        ### cross attention block start###
        x_path1 = self.path1_block3_NLCross(x_path1_0, x_path2_0)
        x_path1 = self.relu(x_path1)
        # torch.save(x_path1, f'/home/rl23/Desktop/data/CorrectTransformationPipeline/feature_map/mri_{case_id[0]}.pth')
        # print("x_path_1_2")
        # print('cross attetnion',x_path1.shape)

        x_path2 = self.path2_block3_NLCross(x_path2_0, x_path1_0)
        x_path2 = self.relu(x_path2)
        # torch.save(x_path2, f'/home/rl23/Desktop/data/CorrectTransformationPipeline/feature_map/us_{case_id[0]}.pth')
        # print("x_path_2_2")
        # print('cross attetntion',x_path2.shape)
