...
class MR_TRUS_4D(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.status == 'train':
            ...
            #new_ini_tre=evaluator.evaluate_transform(new_initial_transform)
...
if __name__ == '__main__':
    ...
    results_dir = '/home/rl23/Desktop/code/dummy/Attention-Reg/experiments/seed42/'
...
#this can remain the same only change the image_dataset
    ...
    exp_lr_scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[120, 170, 250], gamma=0.3) #try gamma=0.1, milestones=[50, 150, 250]
    ...
    fn_hist = os.path.join(results_dir, 'hist_{}_{}_{}_multi_LRgama0.3faninweightdecay0.0001.npy'.format(net, now_str, init_mode))
